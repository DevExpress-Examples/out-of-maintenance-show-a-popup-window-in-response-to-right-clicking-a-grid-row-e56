...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Grid_ClientSideEvents_ShowPopupOnContextMenu_ShowPopupOnContextMenu" %>
...
<script type="text/javascript">
    function OnContextMenu(e) {
        ...
        popup.ShowAtPos(e.htmlEvent.x, e.htmlEvent.y);
    }
...
<body>
    ...
    <dxpc:ASPxPopupControl HeaderText="Notes" EncodeHtml="False" id="popup" runat="server" EnableViewState="False" AllowDragging="true" 
        PopupHorizontalAlign="OutsideRight" PopupHorizontalOffset="10" EnableClientSideAPI="true" PopupElementID="grid">
        <Controls>
